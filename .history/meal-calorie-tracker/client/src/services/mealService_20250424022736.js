...
const mealService = {
  ...
  // Get aggregated meal history for a date range
  getMealHistory: async (startDate, endDate) => {
    try {
      ...
      console.log('Fetching meal history with params:', params);
      ...
      // Assuming the API returns an object like: { "YYYY-MM-DD": { calories: X, ... }, ... }
      // Or an array: [ { date: "YYYY-MM-DD", calories: X, ... }, ... ]
      return response.data; 
    } catch (error) {
