...
const Dashboard = () => {
  ...
  const handleGoalSettingsSave = async (newGoals) => {
    try {
      // Update macro targets with new goals
      const updatedMacroTargets = {
      ...
      setMacroTargets(updatedMacroTargets);
      
      // Update calorie data with new goal
      const newCalorieGoal = newGoals.calorieGoal || calorieData.goal;
      setCalorieData(prev => ({
        ...prev,
        goal: newCalorieGoal,
        remaining: newCalorieGoal - prev.consumed
      }));
