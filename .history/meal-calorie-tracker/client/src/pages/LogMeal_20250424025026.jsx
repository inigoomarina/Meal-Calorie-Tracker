...
const LogMeal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store nutrition values as both direct properties and in the nutrition object 
      // for maximum compatibility with different API versions
      ...
      const sugar = parseFloat(nutrients.sugar) || 0;
      ...
      const mealData = {
        ...
        fiber,
        sugar,
        // Also include structured nutrition object (preferred format)
        nutrition: {
          protein,
          carbs,
          fat,
