    ...
    const loadDashboardData = async () => {
      ...
      try {
        ...
        try {
          ...
          // Only get meals for today specifically with more explicit date filter
        ...
        // Calculate today's calorie total directly from the filtered meals to ensure accuracy
        const todayCalories = processedMeals.reduce((sum, meal) => sum + (meal.calories || 0), 0);
        console.log("Today's calories calculated directly:", todayCalories);
        
        // Update calorie data with accurate today's calories
        const currentCalorieGoal = user?.calorieGoal || 2000;
        setCalorieData({
          consumed: todayCalories,
          goal: currentCalorieGoal,
          remaining: currentCalorieGoal - todayCalories
        });
        ...
        try {
          ...
          if (processedMeals.length > 0) {
            ...
            defaultWeekStats.calories[todayIndex] = todayCalories;
