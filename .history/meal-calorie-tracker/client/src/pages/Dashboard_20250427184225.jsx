    ...
    const loadDashboardData = async () => {
      ...
      try {
        ...
        try {
          ...
          meals = await mealService.getUserMeals({ date: today, _t: cacheBuster });
        ...
        // Strictly filter meals to only today
        const processedMeals = (Array.isArray(meals) ? meals : []).map((meal, index) => {
          try {
            ...
            if (mealDateStr !== today) return null; // Only today
        ...
        // Only sum today's calories for summary
        ...
        try {
          ...
          if (processedMeals.length > 0) {
            ...
            defaultWeekStats.calories[todayIndex] = summaryData.totalCalories || 0;
