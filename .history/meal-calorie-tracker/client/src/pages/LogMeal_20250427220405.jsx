...
const LogMeal = () => {
  ...
  const calculatedNutrients = calculateNutrients(); // Calculate once
    ...
    <div className="log-meal-container">
      ...
      <div className="food-search-section">
        <div className="form-group search-form">
          ...
          {/* Container needed for relative positioning of dropdown */}
          <div className="search-input-wrapper"> 
            <div className="search-input-container">
              <input
                ...
                onFocus={() => searchResults.length > 0 && setShowSuggestions(true)} // Show on focus if results exist
              />
      ...
      {selectedFood && (
        <div className="meal-details-section">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Updated Nutrition Info Section */}
            {calculatedNutrients && (
              <div className="nutrition-info">
                ...
                <div className="nutrition-grid">
                  <div className="nutrition-item calories">
                    ...
                    <span className="value">{calculatedNutrients.calories}</span>
                  </div>
                  <div className="nutrition-item protein">
                    <span className="label">Protein</span>
                    <span className="value">{calculatedNutrients.protein}g</span>
                  </div>
                  <div className="nutrition-item carbs">
                    <span className="label">Carbs</span>
                    <span className="value">{calculatedNutrients.carbs}g</span>
                  </div>
                  <div className="nutrition-item fat">
                    <span className="label">Fat</span>
                    <span className="value">{calculatedNutrients.fat}g</span>
                  </div>
                  {/* Optional: Add Fiber and Sugar if needed */}
                  {calculatedNutrients.fiber > 0 && (
                    <div className="nutrition-item fiber">
                      <span className="label">Fiber</span>
                      <span className="value">{calculatedNutrients.fiber}g</span>
                    </div>
                  )}
                  {calculatedNutrients.sugar > 0 && (
                     <div className="nutrition-item sugar">
                      <span className="label">Sugar</span>
                      <span className="value">{calculatedNutrients.sugar}g</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <button 
              type="submit" 
              className="btn btn-primary btn-log-meal" 
