  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const mealData = {
        ...
        // Add as direct properties for backward compatibility
      ...
      // Add logging around navigation
      console.log("Attempting to navigate to dashboard with refresh...");
      const navigationTarget = '/dashboard?refresh=true&t=' + new Date().getTime();
      navigate(navigationTarget);
      console.log("Navigation call executed for:", navigationTarget);
