...
const LogMeal = () => {
  ...
  return (
    <div className="log-meal-container">
        ...
        <div className="form-group search-form">
          ...
          <div className="search-input-container">
            <input
              ...
              onFocus={() => searchQuery.length >= 2 && setShowSuggestions(true)} // Show suggestions on focus if query exists
            />
            ...
            <div className="suggestions-dropdown" ref={suggestionsRef}>
              {searchResults.map((food) => (
                <div 
                  ...
                  // Use onMouseDown to prevent blur event from hiding dropdown before click registers
      ...
      {isSearching && !selectedFood && ( // Show loading only if not already showing selected food details
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="nutrition-info">
              ...
              <div className="nutrition-grid">
                ...
                {/* Optional: Keep Fiber and Sugar if desired */}
