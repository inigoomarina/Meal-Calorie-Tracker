...
const LogMeal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Use current date and time with timezone
      ...
      const mealData = {
        ...
        time: currentDateTime, // Use current time
      ...
      // Force a page reload when navigating to dashboard to ensure fresh data
      navigate('/dashboard', { replace: true });
      
      // This is a workaround to ensure the dashboard reloads properly
      setTimeout(() => {
